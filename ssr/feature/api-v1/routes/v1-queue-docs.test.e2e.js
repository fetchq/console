describe('v1QueueDocs', () => {
  ...
  it('should list documents', async () => {
    ...
    expect(r1.data.items[0].payload.idx).toBe(1);
    expect(r1.data.items[1].payload.idx).toBe(2);
  ...
  it('should handle pagination with default sorting', async () => {
    ...
    expect(r1.data.items[0].payload.idx).toBe(0);
    expect(r1.data.items[1].payload.idx).toBe(1);
    expect(r1.data.items[2].payload.idx).toBe(2);
    ...
    expect(r2.data.items[1].payload.idx).toBe(4);
    expect(r2.data.items[2].payload.idx).toBe(5);
    ...
    expect(r3.data.items[0].payload.idx).toBe(6);
  });
});
